...
void ViatorParameters::Params::initSliderParams()
{
    ...
    _sliderParams.push_back({ViatorParameters::filter1QID, ViatorParameters::filter1QName, 0.05f, 0.95f, 0.3f, skew::kNoSkew, 0.3, type::kFloat});
    _sliderParams.push_back({ViatorParameters::filter1CutoffID, ViatorParameters::filter1CutoffName, 30.0f, 400.0f, 80.0, skew::kSkew, 100.0, type::kInt});
    ...
    _sliderParams.push_back({ViatorParameters::filter2QID, ViatorParameters::filter2QName, 0.05f, 0.95f, 0.3f, skew::kNoSkew, 0.3, type::kFloat});
    _sliderParams.push_back({ViatorParameters::filter2CutoffID, ViatorParameters::filter2CutoffName, 75.0f, 1000.0f, 500.0f, skew::kSkew, 250.0f, type::kInt});
    ...
    _sliderParams.push_back({ViatorParameters::filter3QID, ViatorParameters::filter3QName, 0.05f, 0.95f, 0.3f, skew::kNoSkew, 0.3, type::kFloat});
    _sliderParams.push_back({ViatorParameters::filter3CutoffID, ViatorParameters::filter3CutoffName, 800.0f, 12500.0f, 2000.0f, skew::kSkew, 5000.0f, type::kInt});
    ...
    _sliderParams.push_back({ViatorParameters::filter4QID, ViatorParameters::filter4QName, 0.05f, 0.95f, 0.3f, skew::kNoSkew, 0.3, type::kFloat});
    _sliderParams.push_back({ViatorParameters::filter4CutoffID, ViatorParameters::filter4CutoffName, 2500.0f, 20000.0f, 10000.0f, skew::kSkew, 10000.0f, type::kInt});
    ...
    _passFilterSliderParams.push_back({ViatorParameters::hpCutoffID, ViatorParameters::hpCutoffName, 20.0f, 20000.0f, 20.0f, skew::kSkew, 1000.0, type::kInt});
    _passFilterSliderParams.push_back({ViatorParameters::lpCutoffID, ViatorParameters::lpCutoffName, 20.0f, 20000.0f, 20000.0f, skew::kSkew, 1000.0, type::kInt});
